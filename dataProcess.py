...
if __name__ == "__main__":
    ...
    # for this part of importing data, the data is too big to upload into github
    # we choose the small one, 
    # while the rest of analysis will base on the one with large sample using the csv in the output file
    # if it is need to reproduce the experiment, download the file(265M) in root from https://grouplens.org/datasets/movielens/latest/
    ...
    #  
    # this part is for replay, but it cost totally 9 hours
